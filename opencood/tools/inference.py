...
def _new_result_stat():
    """Create evaluation accumulators with globally sortable scores."""
    return {
...
def main():
    ...
    result_stat = _new_result_stat()
    result_stat_short = _new_result_stat()
    result_stat_middle = _new_result_stat()
    result_stat_long = _new_result_stat()
