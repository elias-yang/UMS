...
class BaseDataset(Dataset):
    ...
    def __init__(self, params, visualize, train=True, isSim=False,
        ...
        self.single_pc = single_pc
        self.cav_label_only = cav_label_only

        self.pre_processor = None
        self.post_processor = None
        self.ego_id = params.get('ego_id', 0)
        if self.cav_label_only:
            print("Only CAV labels will be used for training/evaluation.")
    ...
    def retrieve_base_data(self, idx, cur_ego_pose_flag=True):
        ...
        for cav_id, cav_content in scenario_database.items():
            ...
            data[cav_id]['scenario_index'] = scenario_index
        return data
